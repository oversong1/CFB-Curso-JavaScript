...
class Bola{
    ...
    controlar=()=>{
        this.constrole_bordas()
        this.px+=this.dirx*this.velx
        this.py+=this.diry*this.vely
        this.eu.setAttribute("style",`left:${this.px};top:${this.py};width:${this.tam};background-color:rgb(${this.r},${this.g},${this.b})`)
